...
import com.dis.tmpdb.repository.user.RoleRepository;
...
public class TemplateDatabaseApplication {
    ...
    @Bean
    CommandLineRunner loadData(TemplateRepository repository, UserRepository userRepository, RoleRepository roleRepository) {
        return args -> {
